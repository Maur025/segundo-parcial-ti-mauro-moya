...
import { PageBreadcrumb } from '../../shared/components/page-breadcrumb/page-breadcrumb';
...
@Component({
  ...
  imports: [ComponentCard, PageBreadcrumb, Button, Badge, Alert],
  templateUrl: './ui-example.html',
